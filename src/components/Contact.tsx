          ...
          <div className="mt-16 pt-16 border-t border-accent/20">
            <div className="flex flex-col items-center space-y-8">
              ...
              <div className="flex flex-wrap justify-center gap-8 text-foreground">
                <a href="tel:+919876543210" className="flex items-center gap-2 hover:text-accent transition-smooth font-medium">
                  <Phone size={20} className="text-accent" />
                  <span>+91 98765 43210</span>
                </a>
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-accent transition-smooth font-medium">
                ...
                <a href="mailto:info@chefonic.com" className="flex items-center gap-2 hover:text-accent transition-smooth font-medium">
                  <Mail size={20} className="text-accent" />
                  <span>info@chefonic.com</span>
                </a>
                <a href="https://instagram.com/chefonic_catering" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-accent transition-smooth font-medium">
